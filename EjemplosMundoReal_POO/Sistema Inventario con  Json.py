...
class Inventario:
    ...
    def actualizar_producto(self, cd, nuevo_nombre, nueva_cantidad, nuevo_precio):
        self.productos[cd].nombre = nuevo_nombre
        self.productos[cd].cantidad = nueva_cantidad
...
# Cargar inventario desde un archivo (si existe)
